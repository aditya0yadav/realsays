        ...
        <div className="py-20 lg:py-32 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
                    <div>
                        <h2 className="text-orange-500 font-bold uppercase tracking-widest text-sm mb-4">Research Excellence</h2>
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-8 tracking-tight">Our Specialist Research Panels</h1>
                        ...
                        <div className="flex gap-4">
                            <button className="px-8 py-4 bg-slate-900 text-white font-bold rounded-2xl hover:bg-slate-800 transition-all active:scale-95 shadow-lg">Partner With Us</button>
                            <button className="px-8 py-4 bg-white border border-gray-200 text-slate-900 font-bold rounded-2xl hover:bg-gray-50 transition-all active:scale-95">Our Capabilities</button>
                        </div>
                    </div>
                    <div className="grid sm:grid-cols-2 gap-6">
                        {features.map((feature, index) => (
                            <div key={index} className="p-8 bg-gray-50/50 rounded-3xl border border-gray-100 hover:border-blue-200 hover:bg-white transition-all duration-300">
                ...
                <div className="bg-blue-600 rounded-[3rem] p-12 lg:p-20 text-white relative overflow-hidden text-center lg:text-left">
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-white pointer-events-none opacity-10 rounded-full -translate-y-1/2 translate-x-1/2 blur-[100px]" />
                        ...
                        <div className="flex justify-center lg:justify-end">
                            <div className="inline-grid grid-cols-2 gap-4">
                                <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                                    ...
                                    <div className="text-blue-100 text-xs font-semibold uppercase tracking-wider">Verification</div>
                                </div>
                                <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                                    <div className="text-3xl font-bold mb-1">5M+</div>
                                    <div className="text-blue-100 text-xs font-semibold uppercase tracking-wider">Users</div>
                                </div>
                            </div>
                        </div>
                    </div>
