        ...
        <div className="space-y-10">
            ...
            {!loading && stats && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Withdrawal Progress */}
                    <div className="bg-[#0F1E3A] rounded-[2.5rem] p-10 text-white relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <span className="text-2xl font-bold tracking-tighter">${stats.balance.toFixed(2)} <span className="text-slate-500 text-sm font-medium">/ $25.00</span></span>
                            </div>

                            <div className="mt-auto space-y-4">
                                <div className="flex items-end justify-between">
                                    <h3 className="text-3xl md:text-4xl font-sans font-[300] leading-tight">
                                        You are <span className="font-bold text-blue-400">${amountToWithdrawal.toFixed(2)}</span><br />
                                        away from withdrawal
                                    </h3>
                                    <TrendingUp className="w-12 h-12 text-blue-500/30 mb-2" />
                                </div>
                    ...
                    {/* Pending Bonus */}
                    <div className="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-xl shadow-blue-900/5 relative overflow-hidden group">
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            ...
                            <div className="mt-auto space-y-6">
                                <div>
                                    <h3 className="text-3xl md:text-4xl font-sans font-[300] text-slate-900 leading-tight">
                                        🎁 <span className="font-bold text-emerald-600">$5.00 Bonus</span><br />
                                        Unlockable Gift
                                    </h3>
                                    <p className="text-slate-400 mt-2 font-medium">Verified reward for active engagement.</p>
                                </div>
                                ...
                                <div className="p-6 rounded-[2rem] bg-slate-50 border border-slate-100 flex items-center justify-between">
                                    ...
                                    <div className="flex -space-x-2">
                                        {[...Array(5)].map((_, i) => (
                                            <div
                                                key={i}
                                                className={`w-4 h-4 rounded-full border-2 border-white ${i < (5 - stats.completions_to_unlock) ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]' : 'bg-slate-200'}`}
                                            />
                                        ))}
                                    </div>
                                </div>
